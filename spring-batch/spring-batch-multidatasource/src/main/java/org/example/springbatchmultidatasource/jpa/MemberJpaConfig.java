...
import static org.example.springbatchmultidatasource.jpa.DataSourceConfig.MEMBER_DATA_SOURCE_BEAN_NAME;
...
public class MemberJpaConfig {
    ...
    public static final String PACKAGE_TO_SCAN = "org.example.springbatchmultidatasource.jpa.member";
